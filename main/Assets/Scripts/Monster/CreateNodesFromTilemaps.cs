...
public class CreateNodesFromTilemaps : MonoBehaviour
{
    ...
    public List<WorldTile> listOfTiles;
    void Awake()
    {
        unsortedNodes = new List<GameObject>();
        generateNodes();
        //Debug.Log("HRE ARE THE SORTED NODES");
    ...
    void createNodes()
    {
        ...
        { //go through the unsorted list of nodes and put them into the 2d array in the correct position
            ...
            //gridOfTiles[wt.gridX, wt.gridY] = wt;
        }
        ...
        Debug.Log("valid floor tiles");
        Debug.Log(floorvalid);
    ...
    public WorldTile GetWorldTile(int x, int y)
    {
        ...
        //Vector3 cellCenterPos = floor.GetCellCenterWorld(new Vector3Int(position.x, position.y, 0));
        Debug.Log("Get World Tile");
        Debug.Log(x);
        Debug.Log(y);
        WorldTile queriedTile = nodes[x, y].GetComponent<WorldTile>();
        //Debug.Log(nodes[position.x, position.y]);
        return queriedTile;
        //return null;
        //foreach(var node in nodes)
        //{
        ...
        //Debug.Log("GET WORLD TILE");
        //Debug.Log(position);
        //Debug.Log(nodes[(int)position.x, (int)position.y]);
        //Debug.Log(queriedTile);
